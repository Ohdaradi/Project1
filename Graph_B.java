...
public class Graph_B {
	...
	public void display_Map() {
		System.out.println("\t Bhubaneswar Travel Optimiser");
		System.out.println("\t------------------");
		System.out.println("----------------------------------------------------\n");
		ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	public static void Create_Map(Graph_B g)
	{
		g.addVertex("Iter Square~B");
		g.addVertex("Baramunda ISBT~B");
		g.addVertex("Airport~B");
		g.addVertex("Biju Patnaik Park~BY");
		g.addVertex("Khordha Bus Stand~B");
		g.addVertex("Sai Temple~B");
		g.addVertex("Mancheswar~BO");
		g.addVertex("Dumduma~B");
		g.addVertex("Sum Hospital~Y");
		g.addVertex("Barabati Stadium~Y");
		g.addVertex("AIIMS Hospital~YO");
		g.addVertex("Nandankanan~B");
		g.addVertex("Kalinga Nagar~O");
		g.addVertex("OUAT~O");
		g.addVertex("AG Square~O");
		g.addVertex("Jaydev Vihar Square~BP");
		g.addVertex("Kalinga Hospital Square~PR");
		g.addVertex("Patia Square~Y");
		g.addVertex("Infocity Square~Y");
		g.addVertex("KIIT Square~P");
		g.addVertex("Khandagiri Square~B");
		g.addVertex("Railway Station~B");
		g.addVertex("Rasulgarh Chowk~B");
		
		
		
		
		g.addEdge("Iter Square~B", "Khandagiri Square~B", 2);
		g.addEdge("Khandagiri Square~B", "Baramunda ISBT~B", 2);
		g.addEdge("Khandagiri Square~B", "Airport~B", 6);
		g.addEdge("Khandagiri Square~B", "Biju Patnaik Park~BY", 5);
		g.addEdge("Baramunda ISBT~B", "Khordha Bus Stand~B", 24);
		g.addEdge("Khandagiri Square~B", "Sai Temple~B", 11);
		g.addEdge("Khandagiri Square~B", "Dumduma~B", 3);
		g.addEdge("Baramunda ISBT~B", "Mancheswar~BO", 10);
		g.addEdge("Baramunda ISBT~B", "Railway Station~B", 6);
		g.addEdge("Baramunda ISBT~B", "Sum Hospital~Y", 5);
		g.addEdge("Rasulgarh Chowk~B", "Sum Hospital~Y", 10);
		g.addEdge("Baramunda ISBT~B", "Rasulgarh Chowk~B", 7);
		g.addEdge("Railway Station~B", "Barabati Stadium~Y", 5);
		g.addEdge("Dumduma~B", "AIIMS Hospital~YO", 3);
		g.addEdge("Baramunda ISBT~B", "Patia Square~Y", 11);
		g.addEdge("Patia Square~Y", "Nandankanan~B", 5);
		g.addEdge("Iter Square~B", "Kalinga Nagar~O", 6);
		g.addEdge("Iter Square~B", "OUAT~O", 4);
		g.addEdge("Biju Patnaik Park~BY", "AG Square~O", 1);
		g.addEdge("Baramunda ISBT~B", "Jaydev Vihar Square~BP", 6);
		g.addEdge("Jaydev Vihar Square~BP","Kalinga Hospital Square~PR", 3);
		g.addEdge("Patia Square~Y", "Infocity Square~Y", 3);
		g.addEdge("Patia Square~Y", "KIIT Square~P", 1);
	...
	public static void main(String[] args) throws IOException{
		Graph_B g = new Graph_B();
		Create_Map(g);
		System.out.println("\n\t\t\t****WELCOME TO THE Bhubaneswar Travels APP*****");
